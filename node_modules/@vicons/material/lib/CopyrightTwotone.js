        ...
        _cache[0] ||
          (_cache[0] = [
            (0, vue_1.createElementVNode)(
              ...
              {
                opacity: '.3',
                d: 'M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8s8-3.59 8-8s-3.59-8-8-8zm-1.92 9.14c.05.33.16.63.3.88s.34.46.59.62c.23.15.53.22.89.23c.21-.01.41-.03.6-.1c.2-.07.37-.17.52-.3c.15-.13.27-.28.36-.46c.09-.18.14-.37.15-.58h1.79c-.01.41-.12.79-.3 1.15c-.18.36-.43.67-.74.94c-.31.27-.67.48-1.08.63c-.41.15-.85.23-1.32.23c-.65 0-1.22-.12-1.7-.34c-.48-.22-.88-.53-1.2-.91s-.56-.83-.71-1.35c-.15-.52-.23-1.06-.23-1.64v-.27c0-.58.09-1.12.24-1.64c.15-.52.39-.97.71-1.36s.72-.69 1.2-.92c.48-.23 1.05-.34 1.7-.34c.51 0 .97.07 1.39.23c.42.16.78.38 1.08.66c.3.28.53.62.7 1.01c.17.39.26.82.28 1.29h-1.79c-.01-.22-.05-.44-.14-.64c-.09-.2-.2-.38-.34-.53c-.14-.15-.32-.27-.52-.36c-.19-.08-.4-.12-.63-.13c-.37.01-.67.08-.91.23c-.25.16-.45.37-.59.62s-.25.54-.3.87c-.05.33-.08.66-.08 1.01v.27c0 .33.03.67.08 1z',
                fill: 'currentColor'
              },
              null,
              -1 /* HOISTED */
