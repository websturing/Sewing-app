        ...
        _cache[0] ||
          (_cache[0] = [
            _createElementVNode(
              ...
              {
                opacity: '.3',
                d: 'M19.41 9H18V7h-2V5.08A7.979 7.979 0 0 0 12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8s8-3.58 8-8c0-1.06-.21-2.07-.59-3zM15.5 8c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11S7 10.33 7 9.5S7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.31-1.46-5.11-3.5h10.22c-.8 2.04-2.78 3.5-5.11 3.5z',
                fill: 'currentColor'
              },
              null,
              -1 /* HOISTED */
